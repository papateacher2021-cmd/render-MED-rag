...
def inicializar_sistema():
    ...
    llm = ChatGoogleGenerativeAI(model="gemini-1.5-flash", google_api_key=api_key, version="v1", temperature=0.1, convert_system_message_to_human=True) # Nota: Uso 1.5-flash que ha funcionado
